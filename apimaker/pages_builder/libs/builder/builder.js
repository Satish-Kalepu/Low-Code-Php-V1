...
/* iframe */
	_loadIframe : function(url) {	
		/*url = "http://localhost:8888/apimaker/apps/6651c91693c0aa7e8a05c3b8/pages_v3";*/
		console.log(url)
		let self = this;
		self.iframe = this.documentFrame;
		var html_data = '<link rel="stylesheet" href="/apimaker/bootstrap/bootstrap.min.css" ><script src="/apimaker/bootstrap/bootstrap.bundle.min.js"></script><script src="/apimaker/bootstrap/popper.min.js"></script><script src="/apimaker/js/vue3.min.prod.js"></script><script src="/apimaker/js/axios.min.js"></script><link rel="stylesheet" href="/apimaker/common.css" /><link rel="stylesheet" href="/apimaker/fontawesome/font-awesome.min.css" />';
		let post = {
			"action" : "get_html_file"
		}
