	...
	<template v-else>
		...
		<div class="graph_object_tabs_nav_bar">
			<div class="graph_object_tabs_nav_container" id="tabs_container">
				...
				<div v-bind:class="{'graph_object_tab_btn':true,'graph_object_btn_active':(data['tab']=='template')}" v-bind:id="'subtab_template'">
					<div v-on:click.prevent.stop="open_template_edit()">Template for {{ data['thing']['i_of']['v'] }}</div>
				</div>
				<div v-bind:class="{'graph_object_tab_btn':true,'graph_object_btn_active':(data['tab']=='template2')}" v-bind:id="'subtab_template2'">
