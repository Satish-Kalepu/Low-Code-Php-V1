<div id="app" v-cloak >
	...
	<div style="position: fixed;left:150px; top:40px; height: 40px; width:calc( 100% - 150px ); background-color: white; overflow: hidden; border-bottom:1px solid #ccc; " >
		<div style="padding: 5px 10px;" >
			...
			<h5 class="d-inline">Page: {{ s2_eeeeeeegap['name'] }}</h5>
	...
	<div v-else>
		...
		<div v-show="edit_tab=='html'" >
			...
			<iframe ref="s2_emarfi_rotide"  class="editor_block_a" id="editor_block_a" ></iframe>
		...
		<div v-show="edit_tab=='control'" >
			<iframe ref="s2_emarfi_lortnoc"  style="position: fixed; left: 150px; top:80px; height:calc( 100% - 90px ); width:calc( 100% - 150px ); "  id="editor_block_aa" ></iframe>
		</div>
	...
	<div class="save_block_a" v-if="edit_tab!='control'" >
		...
		<div style=" display: inline-block; padding: 3px;" >
			<div v-if="s2_ggggggggsm" class="text-success px-3" >{{ s2_ggggggggsm }}</div>
			<div v-if="s2_rrrrrrrrre" class="text-danger px-3" >{{ s2_rrrrrrrrre }}</div>
		</div>
	</div>
